	...
	return (
		<>
			...
			>
				...
				<section
					className={
						"nc-news relative h-[30%] w-[100vw] flex hover:scale-95 active:scale-95 transition-all duration-300 ls:col-start-1 ls:row-start-2 ls:row-span-2 ls:h-[90%] ls:w-[95%] ls:top-0 ls:flex-col ls:gap-4 ls:py-7 ls:pr-7" +
				...
				>
					...
					<div className="absolute z-[3] bg-transparent h-[90%] w-[35vw] right-0 top-[5%] flex flex-col gap-1 px-1 text-left justify-center ls:h-[30%] ls:static ls:ml-auto ls:w-[90%]">
						...
						>
							<div
								className={
									"relative w-[50%] overflow-hidden border-b-[0.35rem] border-my-red transition-all after:absolute after:bottom-0 after:left-0 after:right-0 after:h-0 after:w-full after:bg-my-red after:duration-500 hover:after:h-full px-1 ls:w-[15%]" +
									(isDark
										? " text-white hover:text-dark-bg"
										: " text-black hover:text-light-bg")
								}
