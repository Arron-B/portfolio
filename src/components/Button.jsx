function Button ({text, link, isDark}) {
    return (
        <a
							className="text-sm portrait:mt-1 portrait:pt2:max-ls:w-2/3 landscape:pt:max-ls1:w-[30%] landscape:pt:max-ls1:col-start-2 landscape:pt:max-ls1:h-full"
							href={link}
							target="_blank"
						>
							<div
								className={
									...
									(isDark
                                        ...
                                        (text.length <= 3 ? " portrait:w-1/3 portrait:max-pt3:w-1/4 portrait:ls:w-1/5" : "") + (text.length === 4 ? " portrait:w-1/2 portrait:max-pt3:w-1/3 portrait:ls:w-1/4" : "") + (text.length > 4 ? " portrait:w-2/3 portrait:max-pt3:w-1/2 portrait:ls:w-1/3" : "")
								}
							>
